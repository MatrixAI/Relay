...
linux/net/netfilter/x_tables.c. I'm thinking that this is the function which
upgrades an xtable configuration which is what an iptables update eventually
will call. Inside we can see a reference to a seqlock.

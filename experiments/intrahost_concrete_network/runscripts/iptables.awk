...
{
  print "ip -n $HOSTNET -6 route add ", $1, " dev sink"
  print "ip -n $HOSTNET -6 route add ", $2, " dev sink"
  print "ip -n $HOSTNET address add ", $1, " dev sink"
  print "ip -n $HOSTNET address add ", $2, " dev sink"
